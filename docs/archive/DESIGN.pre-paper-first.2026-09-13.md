<!-- design-authority: historical. Archived verbatim 2026-09-13 from GWTH_V2/DESIGN.md (bead gwth-launch-88z.8.1). This is the pre-FDE aqua/mint and Stone & Sage era token file. It is NOT current: the register is the paper-first register (DESIGN_PAPER_FIRST.md and the paper-first-* items in GWTH-launch-plan/bible/bible.yaml). Restore with: cp docs/archive/DESIGN.pre-paper-first.2026-09-13.md DESIGN.md -->
---
name: GWTH.ai
...
> **SUPERSEDED for student-facing surfaces (2026-06-12):** the FDE journal
> register codified in [DESIGN_FDE.md](DESIGN_FDE.md) (from the implemented
> exemplar `src/components/marketing/home-fde/`, live at `/`) is now the
> design authority for every student-facing surface. This document remains
> the reference for surfaces not yet flipped (see DESIGN_FDE.md §8) and for
> the carried-over discipline (QA gates, banned patterns) restated there.
