...
export const metadata: Metadata = {
  ...
  description:
    "Head-to-head AI labs: two tools run the same real UK work task, outputs side by side, a rubric, and a dated verdict. Included free with your GWTH beta place.",
}
