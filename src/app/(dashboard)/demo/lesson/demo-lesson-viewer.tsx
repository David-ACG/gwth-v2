...
/**
 * Full demo lesson viewer showcasing V11 composite design:
 * - Alternating bg-card / bg-muted/50 section backgrounds
 * - Solid primary number badges
 * - Shadow-md container with border
