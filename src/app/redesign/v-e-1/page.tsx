...
export const metadata = {
  title: "E1 · Civic Press · Refined · Redesign",
}

/**
 * Variant E1 — "Civic Press · Refined Original"
 *
 * Quiet polish on the original Civic Press. Same two-colour palette
 * (navy + burgundy), same Vollkorn body / Public Sans display, same
 * no-gradient discipline. Tightens masthead, refines italics, adds
 * "Issue No." and date elements for civic / newspaper credibility.
 */
export default async function VariantE1() {
    ...
    >
      ...
      <header className="border-b-2 border-foreground bg-background">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-6 px-5 sm:px-8">
          <Link href="/redesign/v-e-1" className="flex items-baseline gap-3">
      ...
      <footer className="bg-background">
        <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8">
          ...
          <div className="mt-6 flex flex-col gap-3 text-[11px] uppercase tracking-[0.14em] text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
            ...
            <span>E1 · Civic Press · Refined · Vol I</span>
          </div>
        </div>
      </footer>
