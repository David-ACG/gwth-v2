...
export const metadata = {
  title: "E · Civic Press · Redesign",
}

/**
 * Redesign Variant E — "Civic Press" · NO GRADIENTS
 *
 * Warm cream surface, deep navy carrier, burgundy accent. Vollkorn
 * (serif body) + Public Sans (display + UI). GOV.UK / FT Weekend
 * lineage — solid colour blocks, dense editorial type hierarchy.
 *
 * No gradient backgrounds, no gradient text, no opacity-wash overlays.
 * The score widget's internal SVG gradient flattens to a solid colour
 * because `--accent` is collapsed to match `--primary` in this scope.
 */
    ...
    >
      ...
      <header className="border-b-2 border-foreground bg-background">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-6 px-5 sm:px-8">
          <Link href="/redesign/v-e" className="flex items-baseline gap-3">
      ...
      <section className="border-b border-border bg-background">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-24">
          {/* Masthead bar */}
          <div className="flex flex-col gap-3 border-b border-foreground/30 pb-5 text-[11px] uppercase tracking-[0.18em] sm:flex-row sm:items-center sm:justify-between">
            <span className="font-bold">Vol I · Issue 01</span>
            <span className="text-muted-foreground">
              UK · Independent · Built for practitioners
            </span>
          ...
          <div className="mt-12 grid gap-14 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
            <div className="max-w-3xl">
              <h1 className="text-[44px] font-bold leading-[0.98] tracking-[-0.025em] sm:text-[60px] md:text-[78px]">
                Stop watching AI change the world.
              </h1>
              <p className="variant-serif mt-6 max-w-xl text-3xl italic leading-[1.05] text-primary sm:text-4xl">
                Start building with it.
              </p>

              <div className="variant-serif mt-10 max-w-xl space-y-4 text-[18px] leading-[1.65] text-foreground/85">
                <p>
                ...
                <p>
                  ...
                  can check on the spot. No PDFs, no faked completion dates,
                  no one-shot certificate that goes stale.
                </p>
              </div>
            ...
            <ol className="space-y-0">
              {PRODUCT_PILLARS.map((p, i) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-[20px] font-bold leading-[1.25] tracking-[-0.01em] sm:text-2xl">
                      {p.title}
                    </h3>
                    <p className="variant-serif mt-3 text-[17px] leading-[1.65] text-foreground/85">
                      {p.body}
                    </p>
                  </div>
                </li>
      ...
      <section id="course" className="border-b border-border">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-24">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-[-0.02em] sm:text-4xl md:text-5xl">
              Different reasons.{" "}
              <span className="variant-serif italic text-primary">
                Same course.
              </span>
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="bg-primary px-2 py-1 text-[11px] font-bold uppercase tracking-[0.14em] text-primary-foreground">
                      {j.tag}
                    </span>
                  ...
                  <h3 className="mt-5 text-[19px] font-bold leading-[1.25] tracking-[-0.01em]">
                    {j.title}
                  </h3>
        ...
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-24">
          <div className="grid gap-10 lg:grid-cols-[1fr_2fr] lg:gap-16">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold leading-[1.05] tracking-[-0.02em] sm:text-4xl md:text-5xl">
            ...
            <div className="space-y-0">
              {UK_STATS.map((stat, i) => (
                ...
                >
                  <div
                    className="text-6xl font-bold tracking-[-0.025em] sm:text-7xl"
      ...
      <section id="pricing" className="border-b border-border">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-28">
          ...
          <p className="variant-serif mt-8 text-[13px] italic text-muted-foreground">
            No yearly price · Cancel anytime · No lock-in · Same per-person
            price for teams.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-background">
        <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8">
          ...
          <div className="mt-6 flex flex-col gap-3 text-[11px] uppercase tracking-[0.14em] text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
            ...
            <span>Variant E · Civic Press · Vol I</span>
          </div>
        </div>
      </footer>
