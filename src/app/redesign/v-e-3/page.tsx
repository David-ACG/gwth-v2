...
export const metadata = {
  title: "E3 · Civic Press · Tonal Sections · Redesign",
}

/**
 * Variant E3 — "Civic Press · Tonal Sections"
 *
 * Civic Press's two-colour palette (navy + burgundy) stays. Each major
 * section gains its own solid tonal background — cream, parchment,
 * stone, sage, clay — so the page reads with rhythm and variation
 * across many sections without breaking the no-gradient discipline.
 *
 * All tints are flat OKLCH fills. Score widget renders flat (accent
 * collapsed to primary in the variant scope).
 */
export default async function VariantE3() {
    ...
    >
      ...
      <header className="border-b-2 border-foreground bg-background">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-6 px-5 sm:px-8">
          <Link href="/redesign/v-e-3" className="flex items-baseline gap-3">
      ...
      {/* ───── Hero — cream (default bg) ────────────────────────────── */}
      <section className="border-b border-border variant-tone-cream">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-24">
          <div className="flex flex-col gap-3 border-b border-foreground/30 pb-5 text-[11px] uppercase tracking-[0.2em] sm:flex-row sm:items-center sm:justify-between">
            <span className="font-bold">Vol I · Issue No. 01</span>
      ...
      {/* ───── Pillars — Parchment tint ─────────────────────────────── */}
      <section
        id="credential"
        className="variant-tone-parchment border-b border-border"
      >
      ...
      {/* ───── Journey grid — Stone tint ────────────────────────────── */}
      <section
        id="course"
        className="variant-tone-stone border-b border-border"
      >
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-24">
          <div className="max-w-3xl">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary">
          ...
          <ul className="mt-14 grid gap-0 border-t-2 border-foreground sm:grid-cols-2 lg:grid-cols-3 sm:border-l-2">
            {journeys.map((j) => (
              ...
              >
                <Link
                  href={j.href}
                  className="group flex h-full flex-col bg-card p-7 transition-colors hover:bg-muted"
                >
      ...
      <section
        id="pricing"
        className="variant-tone-sage border-b border-border"
      >
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-28">
          <div className="max-w-3xl">
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary">
      ...
      {/* ───── Footer — Clay tint ───────────────────────────────────── */}
      <footer className="variant-tone-clay">
        <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8">
          <div className="flex flex-col gap-8 border-b-2 border-foreground pb-8 md:flex-row md:items-start md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
              <div>
                <h3 className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary">Course</h3>
              ...
              <div>
                <h3 className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary">Company</h3>
                <ul className="mt-4 space-y-2 text-[14px]">
              ...
              <div>
                <h3 className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary">Legal</h3>
                <ul className="mt-4 space-y-2 text-[14px]">
          ...
          <div className="mt-6 flex flex-col gap-3 text-[11px] uppercase tracking-[0.14em] text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
            ...
            <span>E3 · Civic Press · Tonal Sections · Vol I</span>
          </div>
        </div>
      </footer>
