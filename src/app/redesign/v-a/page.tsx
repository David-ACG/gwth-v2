...
/**
 * Redesign Variant A — "Field Notebook"
 *
 * Light canonical. Mint drench mid-page (ProductPillars). Ink-Deep-Teal
 * panel near close (FinalCTA). Albert Sans for body + display, JetBrains
    ...
    >
      ...
      <header className="border-b border-border/60 bg-background/80 backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-5 sm:px-8">
          <Link href="/redesign/v-a" className="flex items-center gap-2.5">
      ...
      <section className="relative overflow-hidden">
          ...
          <div className="grid items-start gap-14 lg:grid-cols-[1.15fr_1fr] lg:gap-20">
            <div className="max-w-2xl pt-4">
              <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-muted-foreground">
                A 3-month AI course · UK independent · Built for practitioners
              </p>
              <h1 className="mt-7 text-[44px] font-semibold leading-[1.05] tracking-[-0.02em] sm:text-[56px] md:text-[64px]">
              ...
              <p className="mt-4 max-w-xl text-lg leading-[1.65] text-muted-foreground">
                Every project you ship updates a verifiable credential UK
                employers can check on the spot. No PDFs, no faked completion
                dates, no one-shot certificate that goes stale.
              </p>
        ...
        {/* Hairline rule + research-strip band */}
        <div className="border-t border-border/60">
          <div className="mx-auto max-w-7xl px-5 py-8 sm:px-8">
            <div className="flex flex-col items-start gap-3 text-sm sm:flex-row sm:items-center sm:justify-between">
              ...
              <ul className="flex flex-wrap items-center gap-x-6 gap-y-2 text-[13px] font-medium text-foreground">
      ...
      <section id="credential" className="variant-drench">
        <div className="mx-auto max-w-7xl px-5 py-24 sm:px-8 md:py-32">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-lg leading-[1.6] opacity-85">
          ...
          <ol className="mt-14 grid gap-10 md:grid-cols-3">
            {PRODUCT_PILLARS.map((p) => (
              <li key={p.n} className="flex flex-col">
                ...
                <h3 className="mt-4 text-2xl font-semibold leading-[1.2] tracking-[-0.01em]">
                  {p.title}
                </h3>
                <p className="mt-4 text-[15px] leading-[1.65] opacity-85">{p.body}</p>
              </li>
            ))}
          </ol>
        </div>
            ...
            {UK_STATS.map((stat) => (
              ...
              >
                <div className="flex items-baseline gap-3 text-foreground">
                  <span
                    className="text-5xl font-bold tracking-[-0.02em] sm:text-6xl"
      ...
      <section id="pricing">
        <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 md:py-28">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 max-w-xl text-base leading-[1.65] text-muted-foreground">
              Start free. Learn everything in 3 months. Stay current for less than
              a flat white.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-24 sm:px-8 md:py-32">
          <div className="grid items-end gap-10 lg:grid-cols-[1.4fr_1fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold leading-[1.1] tracking-[-0.015em] sm:text-4xl md:text-5xl">
      ...
      <footer className="border-t border-border/60">
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
          ...
          <div className="mt-12 flex flex-col items-start justify-between gap-3 border-t border-border/60 pt-6 font-mono text-[11px] text-muted-foreground sm:flex-row sm:items-center">
            ...
            <span>Variant A · Field Notebook · v1.0</span>
          </div>
        </div>
      </footer>
