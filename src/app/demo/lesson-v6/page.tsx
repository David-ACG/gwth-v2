...
/**
 * Variant 6: "Elevated Paper" — V5 base with stronger light-mode definition.
 *
 * Changes from V5:
 * - Page background tinted cooler (bg-muted instead of bg-background) in light mode
 * - Card gets a stronger shadow (shadow-md) and crisper border
 * - Section heading badges get a solid primary background with white text
 * - Dividers use a stronger border colour
 * - Breadcrumb pills get subtle fill
 */
export default function LessonV6Page() {
  ...
  return (
    /* Cooler tinted page background — muted in light, background in dark */
    <div className="mx-auto max-w-5xl px-4 py-8">
      <div className="flex gap-8">
        <div className="min-w-0 max-w-[720px] flex-1">
          ...
          {/* Progress breadcrumb — filled pills */}
            ...
            {SECTIONS.map((s, i) => (
              <div key={s.id} className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-full bg-muted px-3 py-1 text-xs font-medium text-muted-foreground transition-colors hover:bg-primary/10 hover:text-foreground"
                >
          ...
          {/* Main card — stronger shadow and border */}
...
/** Solid primary badge section heading */
