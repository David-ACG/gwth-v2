...
export const ARGUMENT = [
  ...
  },
  {
    kicker: "Figure 02",
    value: "3.5 times",
    body: "The firms using AI most deeply, the ones OpenAI calls frontier firms, use three and a half times more of it per worker than typical firms, up from twice a year earlier. Only 36% of that gap is volume. The rest is deeper, more capable use.",
          ...
          <div className={styles.heroGrid}>
            ...
            <div>
              <p className={p.standfirst}>
                Almost everyone in your profession has already used AI. Very
                few have the foundation to use it well, and the gap is
                widening: OpenAI&apos;s own data shows the firms using AI most
                deeply now use three and a half times more of it per worker
                than typical ones. GWTH is the three month applied foundation
                your people complete before your own training lands.
              </p>
