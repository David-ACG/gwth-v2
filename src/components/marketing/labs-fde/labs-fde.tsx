        ...
        <div className={styles.page}>
          ...
          <div className={styles.standfirstBlock}>
            <p className={styles.standfirst}>
              Each lab runs two AI tools head to head on a real job, with the
              same prompt, and shows you both answers side by side. A short
              rubric helps you call the winner. Lessons teach you how; labs show
              you which tool when.
            </p>
            ...
            <p className={styles.standfirst} data-testid="labs-uk-note">
              The tasks are British ones, because that is the test that tells
              you anything. A care home in Shropshire that cannot fill a nursing
