...
/* Variant 2 (windmill) uses one blade colour per journey card so the
   accent palette across the page mirrors the 7 windmill blades. The
   blade names match the CSS custom properties added in styles-extras. */
const JOURNEYS = [
  {
    n: '01',
    tag: 'Worried',
